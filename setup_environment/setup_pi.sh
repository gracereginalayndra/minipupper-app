...
# ──────────────────────────────────────────────────────
# Minipupper + OpenClaw Setup — Pi Side
# Part of: Minipupper-Openclaw-Backup-2  (2-script version)
#
# Run on the Pi:
#   cd Minipupper-Openclaw-Backup-2 && ./setup-pi.sh
#
# Pair with: setup-gateway.sh (run on gateway VM)
# ──────────────────────────────────────────────────────
...
║         (Pi side — 2-script version)    ║
╚══════════════════════════════════════════╝${NC}"
echo ""
echo "Run this on the Pi. Then run setup-gateway.sh on the gateway VM."
echo ""
...
# ──────────────────────────────────────────────────────
# 7 — Node connection (prints request ID for setup-gateway.sh)
# ──────────────────────────────────────────────────────
...
echo ""
echo -e "${BOLD}Starting node connection...${NC}"
echo ""
echo -e "${YELLOW}══════════════════════════════════════════════════════════${NC}"
echo -e "${YELLOW}  LOOK FOR THE REQUEST ID ABOVE ⬆${NC}"
echo -e "${YELLOW}  Then run on your gateway VM:${NC}"
echo -e "${YELLOW}    ./setup-gateway.sh approve <REQUEST_ID>${NC}"
echo -e "${YELLOW}══════════════════════════════════════════════════════════${NC}"
echo ""
